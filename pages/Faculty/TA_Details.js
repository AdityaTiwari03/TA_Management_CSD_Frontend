...
export default function Dashboard() {
  ...
  const fetchData = async (idNumber) => {
    try {
      ...
      set_TA_Name(
        resp2.data.data.firstName[0].toUpperCase() +
          resp2.data.data.firstName.slice(1) +
          " " +
          resp2.data.data.lastName[0].toUpperCase() +
          resp2.data.data.lastName.slice(1)
      );
      ...
      set_TA_Info({
        ...
        primaryProgrammingSkills:
          resp.data.data.userInfo.primaryProgrammingSkills,
        secondaryProgrammingSkills:
          resp.data.data.userInfo.secondaryProgrammingSkills,
      ...
      <div className="main">
        <div className={dashboard.whitebox}>
          ...
          <div className="flex gap-5 mb-10">
            <div className="w-3/5 h-72 overflow-scroll">
            ...
            <div className="w-1/4 h-72 overflow-scroll">
              {" "}
